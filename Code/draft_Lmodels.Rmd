...
```
I don't really understand what the output is telling me...
...
```
Based on this plot, it looks like there is an interaction present. The question I need to answer is `Does the effect of the before and after measurements on L depend on what kind of ligth treatment the copepods were exposed to?`
