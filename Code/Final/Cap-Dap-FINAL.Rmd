...
Fig 1. Microscope photograph of *A. leptopus* specimens under 1.0x magnification.
...
I then need to set things up for my code, so here I am clearing R's brain so that I am starting with a clean slate. I am also uploading the `tidyverse`, `ggfortify`, and `here` packages in anticipation of manipulating and modeling my data.
...
I can then upload my raw data from the uploaded .csv file:
